...
Lightfoot's development closely follows the pattern established by [Hitchmap-Nostr](https://github.com/Hitchwiki/hitchmap-nostr) due to the similarity in:
...
- **Trustroots Lightfoot Circle**: [Join the community](https://www.trustroots.org/circles/lightfoot)
- **Wiki**: [Lightfoot documentation](https://wiki.trustroots.org/en/Lightfoot)

## 🙏 Acknowledgments

Special thanks to the [Hitchmap-Nostr](https://github.com/Hitchwiki/hitchmap-nostr) project for providing architectural guidance and proven patterns for Nostr-based mapping applications.
