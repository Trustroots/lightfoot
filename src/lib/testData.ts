...
export const exampleNotes: NDKRawEvent[] = [
  // Regular Lightfoot note - Berlin
  {
    ...
    content: 'Just dropped off some letters at the Berlin lightfoot box! Amazing community here. Looking forward to picking up letters heading to Prague next week. #sustainability #travel',
    tags: [
      ['t', 'lightfoot'],
  ...
  // Lightfoot box - Amsterdam
  {
    ...
    content: JSON.stringify({
      ...
      content: 'Lightfoot box in Amsterdam Central Library. Available 24/7, check with librarian on 2nd floor. Perfect spot for European letter exchanges!'
    }),
    tags: [
      ['t', 'lightfoot'],
      ['t', '#lightfootbox'],
  ...
  // Regular Lightfoot note - Barcelona
  {
    ...
    content: 'Hitchhiked from Barcelona to Valencia carrying 3 lightfoot letters! Met amazing people along the way. The sustainable travel community is growing 🌱 #lightfoot #hitchhiking',
    tags: [
      ['t', 'lightfoot'],
  ...
  // Lightfoot box - Paris (scheduled availability)
  {
    ...
    content: JSON.stringify({
      ...
      content: 'Paris hackspace lightfoot box. Available Wed-Sun 14:00-20:00. Ring bell for access. Great community of makers and travelers!'
    }),
    tags: [
      ['t', 'lightfoot'],
      ['t', '#lightfootbox'],
  ...
  // Regular Lightfoot note - Prague
  {
    ...
    content: 'Beautiful letter delivery in Prague old town today! The handwritten note from a grandmother to her grandchild in Vienna brought tears to my eyes. This is what lightfoot is all about ❤️',
    tags: [
      ['t', 'lightfoot'],
  ...
  // Lightfoot box - Vienna (host availability)
  {
    ...
    content: JSON.stringify({
      ...
      content: 'Vienna apartment lightfoot box. Contact me via nostr DM before visiting. I host travelers and maintain a small letter exchange. Couch available for lightfoot deputies!'
    }),
    tags: [
      ['t', 'lightfoot'],
      ['t', '#lightfootbox'],
  ...
  // Regular Lightfoot note - London
  {
    ...
    content: 'Cycled across London today delivering lightfoot letters! From Camden to Greenwich, spreading handwritten love across the city. Met a lovely elderly couple who remembered sending letters this way in the 70s 📮',
    tags: [
      ['t', 'lightfoot'],
  ...
  // Lightfoot box - Edinburgh (transient)
  {
    ...
    content: JSON.stringify({
      ...
      content: 'Temporary lightfoot box at Edinburgh Festival! Located at the Grassmarket hostel until end of August. Perfect for festival-goers to exchange letters with fellow travelers.'
    }),
    tags: [
      ['t', 'lightfoot'],
      ['t', '#lightfootbox'],
  ...
  // Regular Lightfoot note - Rome
  {
    ...
    content: 'Just delivered a beautiful poem written on handmade paper from Florence to Rome! The recipient was so moved they immediately wrote a reply to send back north. The circle of lightfoot letters continues! 🇮🇹',
    tags: [
      ['t', 'lightfoot'],
  ...
  // Lightfoot box - Munich (public)
  {
    ...
    content: JSON.stringify({
      availability: 'public' as Availability,
      content: 'Munich central station lightfoot box! Located in the travelers lounge, 3rd floor. Open 24/7. Great connection point for letters going all over Europe and beyond.'
    }),
    tags: [
      ['t', 'lightfoot'],
      ['t', '#lightfootbox'],
