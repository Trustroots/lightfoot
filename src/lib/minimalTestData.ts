...
export const minimalTestNotes = [
  // Simple lightfoot note
  {
    ...
    content:
      'Delivered letters from Berlin to Prague by train! #sustainabletravel',
    tags: [
      ['t', 'lightfoot'],
  ...
  // Simple lightfoot box
  {
    ...
    created_at: 1699123456,
    content:
      '{"availability":"public","content":"Test lightfoot box in Amsterdam"}',
    tags: [
      ['t', 'lightfoot'],
      ['t', '#lightfootbox'],
  ...
  // Another simple note
  {
    ...
    created_at: 1699123456,
    content:
      'Hitchhiked with 5 letters from Paris to Barcelona! Amazing journey.',
    tags: [
      ['t', 'lightfoot'],
